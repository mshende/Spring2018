...
public class Span3DExample extends Application {
	...
	for (double alpha=alphaLow; alpha<=alphaHigh; alpha+=alphaStep) {
		...
		for (double gamma=gammaLow; gamma<=gammaHigh; gamma+=gammaStep) {	    
		    double[] temp1 = lin.scalarProduct (alpha, u);
		    double[] temp2 = lin.scalarProduct (beta, v);
		    double[] temp3 = lin.scalarProduct (gamma, w);
		    double[] temp4 = lin.add (temp1, temp2);
		    double[] z = lin.add (temp4, temp3);
		    // Draw

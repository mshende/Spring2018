...
// 	double[] a = {0,0,3,0,5,0,0,0,0,0,0};   // a[2]=2, a[4]=5, a[9]=0
 	double[] a = {0,0,3,0,0,0,0,0,0,0,0};   // a[2]=2, a[4]=0, a[9]=0
	...
	double sum = 0;
	for (int i=0; i<=N; i++) {
	    sum = sum + (a[i]*Math.sin(2*Math.PI*i*t)) + (b[i]*Math.cos(2*Math.PI*i*t));
	}
	return (a0+sum);
